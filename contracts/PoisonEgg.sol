...
contract PoisonEgg is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(
        ...
        address _ores,
        address _mnaNFT
    ) ERC721A("Poison Egg", "Poison Egg", _maxBatchMintSize) {
        ores = _ores;
        mnaNFT = IMnA(_mnaNFT);
    }
        ...
        nonReentrant
    {
        ...
        require(mnaNFT.isMarine(tokenId), "You can mint with a marine");
